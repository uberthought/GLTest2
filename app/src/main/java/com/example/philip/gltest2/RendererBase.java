...
abstract class RendererBase implements GLSurfaceView.Renderer {
    ...
    String resourceToString(int resourceId) {
        try {
    ...
    void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            Log.e(RendererBase.TAG, op + ": glError " + GLUtils.getEGLErrorString(error));
